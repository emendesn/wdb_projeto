...
±±ºPrograma  ³ RELNATUR º Autor ³ Edilson Mendes     º Data ³  30/03/11   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Relatorio para impressão da relacao de Naturezas por       º±±
±±º          ³ periodo.                                                   º±±
...
user Function RELNATUR()

Local cPict          := ""
Local titulo         := "Relacao de Naturezas"
Local nLin           := 80
Local Cabec1         := ""
Local Cabec2         := ""
Local imprime        := .T.
...
Private limite       := 80
Private tamanho      := "P"
Private nomeprog     := "RELNATUR" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo        := 18
